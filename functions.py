...
def forward():
    ...
    # Ensure sum_i is not zero before performing division
    if sum_i != 0:
        ...
        # Handle the case when sum_i is zero (optional)
        # For example, stop the motors or take corrective action
        print("No sensor readings, cannot calculate position.")
